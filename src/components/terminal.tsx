...
const WhatsAppIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
      ...
      {...props}
    >
        <path d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2 22l5.25-1.38c1.45.79 3.08 1.21 4.79 1.21h.01c5.46 0 9.91-4.45 9.91-9.91s-4.45-9.91-9.91-9.91zM17.17 14.35c-.24-.12-1.45-.72-1.67-.8s-.39-.12-.55.12c-.16.24-.63.8-.78.96-.14.16-.28.18-.52.06-.24-.12-1.02-.38-1.94-1.2s-1.5-2.11-1.38-2.45c.12-.34.06-.52-.06-.68s-.55-1.32-.75-1.81c-.2-.48-.4-.42-.55-.42h-.5c-.16 0-.42.06-.63.3s-.84.82-.84 2c0 1.18.86 2.31 1 2.47.14.16 1.75 2.67 4.24 3.73.59.26 1.05.41 1.41.52.6.18 1.15.16 1.58.1.48-.07 1.45-.59 1.65-1.16.2-.56.2-1.04.14-1.16-.06-.12-.22-.18-.46-.3z" />
    </svg>
);
